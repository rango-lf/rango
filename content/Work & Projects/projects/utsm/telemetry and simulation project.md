...
In previous years, UTSM Prototype relied on intuitive strategy (i.e. general driving strategy). However, this year (2026-27) and onwards, we want to invest into data-driven strategy to gain better insights into our vehicle's energy efficiency, speed, throttle, etc. during the race. As well, we are aiming to enter the SEMA Data and Telemetry Award contest sponsored by Schmid Elektronik. 
...
## github repo
The link below contains the Python tools I, and the 2026-27 Proto Captain (and dear friend) Brayden, have worked on. 
