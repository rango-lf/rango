...
To start, this is not a research-based essay on the impacts, ethics, and public opinions associated with generative AI (e.g. LLMs). Rather, this is a personal manifesto on how I view and use this technology in an academic context.
...
The COVID-19 pandemic made this impossible to ignore. For a brief window, academic institutions demonstrated that flexible, accessible, and remote learning was entirely logistically possible. And then, as soon as it was politically convenient, students were funnelled back into lecture halls with poor ventilation and even poorer contingency planning. It was made very clear, very quickly, that the comfort and physical wellbeing of students was secondary to getting everyone back in their seats so the institution could operate (read: make a profit) as normal. That is not a neutral act. It communicates something about what students are worth to these institutions, and students noticed.

Add to that a job market that has worsened significantly across nearly every sector. For years the promise has always been implicit: tolerate the stress, the debt, the hoops, and eventually you will be rewarded with financial stability and upward mobility. When students look at the increasing costs of a degree against the socio-economic state they will be graduating into, the math doesn't add up. The carrot on the stick is becoming increasingly unattainable. 
...
For students with disabilities, the applications can be even more significant. Transcribing lectures, reformatting dense notes into more digestible bites, and breaking down complex readings are things a well-prompted LLM can do quickly and reliably. For students managing conditions that affect how they process information, how much energy they can devote to schooling, etc., having that kind of on-demand support is incredibly helpful.
...
>*"When Alan launched in a 450-student programming course in January 2025, it operated on a single principle: every answer had to be grounded in official course material and backed by citation. No hallucinating. No guessing. Just reliable, course-specific support, available whenever a student needed it."*

I would definitely like to see more initiatives like this. Not AI grafted awkwardly onto existing structures, but AI designed thoughtfully, with the actual needs of students in mind, and with accountability built in that makes it trustworthy.

Generative AI is not going away. It is going to become more capable, more integrated, and more present in every part of academic and professional life. The question was never really whether to engage with it--that ship has sailed. The question is how to engage with it in a way that is honest, intentional, and serves the goal of a love for learning. This is what I am trying to do and hold myself to, and I hope you will too.